<template>
	...
	<header class="product-header">
	    ...
	    <span class="header-center"><p>产品报价</p></span>
	    <span class="header-right">
			<a href="javascript:;" class="header-right-button"
				@click="comfirmAddPrice">确认</a>
	    </span>
	</header>
	<div class="product-wrap">
		<div class="card-container">
			<div class="mui-card mui-card-no-line">
				<div class="mui-card-header">价格</div>
				<div class="mui-card-content">
					<div class="mui-card-content-inner">
						<form class="mui-input-group mui-input-border-label" style="margin-top: 0;">
							<input type="text" placeholder="请输入整数" name="price" style="width: 70%;"
								v-model="newPrice.price" @keyup="numberThePrice | debounce">		
							<label for="price">人民币/天</label>
						</form>
					</div>
				</div>
			</div>
			<div class="mui-card mui-card-no-line">
				<div class="mui-card-header">价格说明（不超过20个字）</div>
				<div class="mui-card-content">
					<div class="mui-card-content-inner">
						<form class="mui-input-group" style="margin-top: 0;">
							<div class="mui-form-row">
								<textarea rows="9" style="height:92px" placeholder="途牛产品棒棒哒" maxlength="20" v-model="newPrice.introduction"></textarea>
							</div>
						</form>
					</div>
				</div>
