define(function(require, exports, module) {
	...
	module.exports=Vue.extend({
		...
		template:'<div class="page2" style="display: block;"><header class="product-header" data-type="1"><span class="header-left" onclick="javascript:history.go(-1)"><i class="icon-title-back effect-active"></i></span><span class="header-center"><p>选择项目</p></span><span class="header-right"><a href="javascript:;" v-link="{path:&#39;addRoute&#39;}" class="header-right-button mui-btn-add-middle"></a></span></header><div class="product-wrap"><div class="card-container"><div class="mui-card mui-card-no-pad"><div class="mui-card-content"><div class="mui-card-content-inner"><ul class="mui-table-view"><li class="mui-table-view-cell mui-transitioning mui-listItem" v-touch:swipeleft="swiperSlide" v-for="route in routeArray"><div class="mui-slider-right mui-disabled" @click.stop="deleteRoute(route)"><a class="mui-btn mui-btn-red" style="transform: translate(0px, 0px);">删除</a></div><div class="mui-slider-handle" style="transform: translate(0px, 0px);"><div class="mui-table-view-cell-inline"><a class="mui-table-view-cell-column" v-link="{path:&#39;addRoute&#39;,query:{id:route.id}}"><div class="mui-btn-edit-icon"></div></a><div class="mui-table-view-cell-column" style="width: 85%;">{{route.title}}</div><div class="mui-table-view-cell-column"><div class="_checkbox" :class="route.isSelected ?&#39;active&#39;:&#39;&#39;" @click="route.isSelected =!route.isSelected"></div></div></div></div></li></ul></div></div></div></div></div><footer><a class="footer-button footer-button-next" @click="selectWanfa">完成</a></footer></div>'
	});
});